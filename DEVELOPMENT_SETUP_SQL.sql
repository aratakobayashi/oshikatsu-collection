...
UNION ALL
SELECT 
  'episode_locations' as table_name, COUNT(*) as count FROM public.episode_locations
UNION ALL
SELECT 
  'episode_items' as table_name, COUNT(*) as count FROM public.episode_items
UNION ALL
SELECT 
