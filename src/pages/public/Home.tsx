...
import { ArrowRight, Calendar, MapPin, Package, Users, ChevronLeft, ChevronRight, Star, Search, Heart, Sparkles } from 'lucide-react'
...
const ImprovedHeroSection = ({ onSearch }: { onSearch: (query: string) => void }) => {
